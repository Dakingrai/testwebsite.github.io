...
<div class="profile-container">
  ...
  <div class="profile-text">
    ...
    <p> My recent work focuses on exploring the internal mechanisms of language models through <a href="https://arxiv.org/pdf/2407.02646"> mechanistic interpretability (MI) </a>. I'm exploring a top-down MI framework to link mechanistic components with high-level behaviors, motivated by the lack of a systematic mapping between these levels and the uncertainty that low-level understanding explains higher-level emergent behaviors. I would love to chat if you're also interested in this problem, or in any topic related to language models.  </p>
